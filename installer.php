...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221103_test_00ea4faf3a6ebdfe1221_20221103153335_archive.zip';
        const ARCHIVE_SIZE       = '24242212';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '00ea4fa-03153335';
        const SECONDARY_PACKAGE_HASH = '913a3c4-03153335';
        const VERSION            = '1.5.0';
